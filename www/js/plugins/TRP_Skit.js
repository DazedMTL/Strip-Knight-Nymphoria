...
(function () {
	...
	TRP_CORE.easingValue = function (t, b, c, d, type) {
		var EASING = this.EASING;
		switch (type) {
			case EASING.easeInQuad:
				return this.easingInQuad(t, b, c, d);
			case EASING.easeOutQuad:
				return this.easingOutQuad(t, b, c, d);
			case EASING.easeInOutQuad:
				return this.easingInOutQuad(t, b, c, d);
			case EASING.easeInCubic:
				return this.easingInCubic(t, b, c, d);
			case EASING.easeOutCubic:
				return this.easingOutCubic(t, b, c, d);
			case EASING.easeInOutCubic:
				return this.easingInOutCubic(t, b, c, d);
			default:
				return this.easingLinear(t, b, c, d);
		}
	};
	TRP_CORE.easingLinear = function (t, b, c, d) {
		return c * t / d + b;
	};
	TRP_CORE.easingInQuad = function (t, b, c, d) {
		return c * t * t / d / d + b;
	};
	TRP_CORE.easingOutQuad = function (t, b, c, d) {
		return -c * t / d * (t / d - 2) + b;
	};
	TRP_CORE.easingInOutQuad = function (t, b, c, d) {
		t /= d / 2;
		if (t < 1) { return c / 2 * t * t + b; }
		t -= 1;
		return -c / 2 * (t * (t - 2) - 1) + b;
	};
	TRP_CORE.easingInCubic = function (t, b, c, d) {
		t /= d;
		return c * t * t * t + b;
	};
	TRP_CORE.easingOutCubic = function (t, b, c, d) {
		t /= d;
		t -= 1;
		return c * (t * t * t + 1) + b;
	};
	TRP_CORE.easingInOutCubic = function (t, b, c, d) {
		t /= d / 2;
	...
	TRP_CORE.supplementSkitWait = function (default_value, opt_arg) {
		var ret = TRP_CORE.supplementDef(default_value, opt_arg, ['wait']);
	...
	Skit.prototype.processCommand = function (args, macroPos) {
		...
		var macroArgs = parameters.macro[skitCommand];
		var i, length;
	...
	Skit.prototype.slideInSkitActor = function (args, macroPos) {
		...
		if (actor._showing) {
			actor.movePosition(wait, easeType, position, speed, false);
		} else {
	...
	SkitActor.prototype.movePosition = function (wait, easeType, position, speed, relative) {
		...
		relative = TRP_CORE.supplementDef(false, relative);
		var targetPos = this._calcMovePosition(position, relative);
	...
	/* sequence
	===================================*/
	SkitActor.prototype.playSequence = function (wait, position, macroCommands) {
		wait = TRP_CORE.supplementSkitWait(false, wait);
